...
class ProductoBulkStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'productos.*.tipo' => ['nullable', 'string', 'in:producto,servicio,renta'],
            'productos.*.codigo_fabricante' => ['nullable', 'string', 'max:100'],
            ...
            'productos.*.tags' => ['nullable', 'array'],
            'productos.*.tags.*' => ['string', 'max:100'],
            'productos.*.presentacion' => ['nullable', 'string', 'max:255'],
            'productos.*.disponibilidad' => ['nullable', 'string', 'max:50'],
            'productos.*.tiempo_entrega' => ['nullable', 'string', 'max:100'],
            'productos.*.url_producto' => ['nullable', 'string', 'max:500'],
    ...
    public function messages(): array
    {
        return [
            ...
            'productos.*.tipo.in' => 'El tipo debe ser producto, servicio o renta.',
