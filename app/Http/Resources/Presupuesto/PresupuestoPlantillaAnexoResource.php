...
/**
 * @mixin \App\Models\PresupuestoPlantillaAnexo
 */
class PresupuestoPlantillaAnexoResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            'id' => $this->id,
            'presupuesto_plantilla_id' => (int) $this->presupuesto_plantilla_id,
            // Alias para reutilizar UI de captura de PPTO.
            'presupuesto_id' => (int) $this->presupuesto_plantilla_id,
            'titulo' => $this->titulo,
            ...
            'archivo_aspect_ratio' => $this->archivo_aspect_ratio !== null
                ? (float) $this->archivo_aspect_ratio
                : null,
