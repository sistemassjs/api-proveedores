@php
    ...
    $headerEnd = $theme['header_end'] ?? '#1d4e89';
@endphp
<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%"
  style="width:100%;border-collapse:collapse;mso-table-lspace:0pt;mso-table-rspace:0pt;">
  <tr>
    <td bgcolor="{{ $header }}" align="center" valign="top"
      style="padding:0;margin:0;background-color:{{ $header }};border-bottom:1px solid #cbd5e1;">
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%"
        style="width:100%;border-collapse:collapse;">
        <tr>
          <td bgcolor="{{ $header }}" align="center"
            style="padding:28px 20px;background-color:{{ $header }};background-image:linear-gradient(135deg,{{ $headerEnd }} 0%,{{ $header }} 100%);text-align:center;">
